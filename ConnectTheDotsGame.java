...
public class ConnectTheDotsGame extends JPanel implements MouseListener {
    private final int GRID_SIZE = 5;       // Grid of 5x5
    private final int CELL_SIZE = 100;     // Size of each grid cell
    private final int DOT_RADIUS = 20;     // Dot size
    private ArrayList<ColoredPoint> dots;  // Colored visible dots
    private ArrayList<ColoredLine> lines;  // Lines between dots
    private ColoredPoint[][] invisibleDots; // Grid of invisible dots
    private ColoredPoint firstClick = null;
